...
DROP_TABLES: tuple[str, ...] = (
    "airank_audit_events",
    "airank_integration_capabilities",
    "airank_outbox_events",
    "airank_async_jobs",
    "airank_object_refs",
    "airank_reports",
    "airank_retest_runs",
    ...
    "airank_fact_sources",
    "airank_fact_atoms",
    "airank_source_citations",
    "airank_answer_snapshots",
    "airank_scan_tasks",
    "airank_scan_runs",
    "airank_buyer_questions",
    "airank_competitors",
    "airank_project_members",
    "airank_projects",
    "airank_user_bindings",
    "airank_tenant_bindings",
)
