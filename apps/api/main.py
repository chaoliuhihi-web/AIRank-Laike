...
ERROR_REGISTRY: dict[str, tuple[int, str]] = {
    ...
    "OPPORTUNITY_ACTION_DIRECTORY_BINDING_NOT_FOUND": (404, "Opportunity action directory binding was not found"),
    "OPPORTUNITY_ACTION_DIRECTORY_VERSION_CONFLICT": (409, "Opportunity action directory binding version is stale"),
    ...
    "PUBLISH_MUTATION_CHANNEL_UNSUPPORTED": (409, "Publication channel does not support governed mutations"),
    "PUBLISH_MUTATION_REMOTE_ID_MISSING": (409, "Publication mutation target has no remote identifier"),
    "PUBLISH_MUTATION_REMOTE_ID_INVALID": (409, "Publication mutation target remote identifier is invalid"),
    ...
    "EVIDENCE_REVIEW_ASSIGNMENT_NOT_FOUND": (404, "Evidence review assignment was not found"),
    "EVIDENCE_REVIEW_ASSIGNMENT_CONFLICT": (409, "Evidence review task is assigned to another reviewer"),
    "EVIDENCE_REVIEW_ASSIGNMENT_NOT_ACTIVE": (409, "Evidence review assignment is not active"),
    ...
    "OPERATION_IDEMPOTENCY_KEY_INVALID": (422, "Operation idempotency key is invalid"),
    "OPERATION_IDEMPOTENCY_CONFLICT": (409, "Operation idempotency key payload conflict"),
    "OPERATION_IN_PROGRESS": (409, "Operation is already in progress"),
...
try:
    from .opportunity_directory_routes import router as opportunity_directory_router
except ImportError:  # pragma: no cover
    from opportunity_directory_routes import router as opportunity_directory_router  # type: ignore[no-redef]

app.include_router(opportunity_directory_router)
